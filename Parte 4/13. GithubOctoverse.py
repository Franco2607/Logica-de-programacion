# Es para hacer peticiones http (llamar APIs en internet)
import requests


def generar_reporte_github(username: str):
...
# repo.get("languaje") coge el lenguaje principal del repo
...
generar_reporte_github(username)
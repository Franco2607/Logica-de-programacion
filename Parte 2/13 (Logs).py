...
# Level = debug es para mostrar todos los niveles
# Format = "%(asctime)s ((tiempo))- %(levrlname)s - %(message)s"
# Para ficheros se usaria handlers
# Para medir el tiempo de cada proceso por medio de logs es importanto time 
# y se usaria start_time = time.time() y end_time = time.time
